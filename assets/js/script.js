...
function renderAppointments() {
  ...
  console.log("here", oldAppoinmentDetails);
  ...
  for (let i = 0; i < appointmentDetails.length; i++) {
    ...
    var appointmentCardData = `
        <p class='my-3'><span class='has-text-weight-semibold'>Username:</span> ${appointmentDetails[i].name}</p>
        <p class='my-3'><span class='has-text-weight-semibold'>Appointment Date:</span> ${appointmentDetails[i].appointmentDate}</p>
        <p class='my-3'><span class='has-text-weight-semibold'>Appointment Time:</span> ${appointmentDetails[i].appointmentStartTime}</p>
        <p class='my-3'><span class='has-text-weight-semibold'>For Whom:</span> ${appointmentDetails[i].appointmentWhom}</p>
        <p class='my-3'><span class='has-text-weight-semibold'>Appointment With:</span> ${appointmentDetails[i].appointmentWith}</p>
    ...
    console.log("item1", appointmentDetails[i].name + "index" + i);
...
//appointmentEntryButton.addEventListener("click", renderAppointments);
...
function onLoad() {
  ...
  appointmentEntryButton.setAttribute(
    "class",
    "create-appointment-entry-button button is-link is-size-4 p-5"
  );
  appointmentDateSection.setAttribute("class", "is-hidden");
